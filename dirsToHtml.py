...
htmlCode = '<html><head><link rel="stylesheet" href="${CSSFILE}"></head><body><div id="container">\n<div id="cHeader">${TITLE}<br><div id="headerText">${INTROTEXT}</div></div> <div id="qnav"><div id="dirnavtitle">${DNAVTITLE}</div><div id="dirnav">${DIRNAV}</div></div> <div id="content"> <ol id="nestedlist">'
